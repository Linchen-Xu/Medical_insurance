...
public class Comp extends JFrame{
	...
	String[] column = {"id","name","category"};
	String[] data = {"a","b","c"};
	Integer size;
	/**
	 ...
	 * @throws Exception 
	 */
	public Comp(int i) throws Exception {
	...
	public Comp() {
        ...
        try {
			readcomp("D:\\eclipse files\\java-neon\\Java_design\\files\\companies.txt");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\companies.txt");
	...
	public void readcomp(String filename) throws Exception{
	...
	public void save(String filename) throws Exception{
		...
		writer.flush(); 
		for(int i=0;i<size;++i){
			line = model.getValueAt(i,0) + "_" + model.getValueAt(i,1) + "_" + model.getValueAt(i,2);
			writer.write(line);
			writer.newLine();
			writer.flush(); 
		}
