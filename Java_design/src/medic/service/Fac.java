...
public class Fac extends JFrame{
	 ...
	 * @throws Exception 
	 */
	public Fac(int i) throws Exception {
	...
	public Fac() {
        ...
        try {
			readper("D:\\eclipse files\\java-neon\\Java_design\\files\\facility.txt");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\facility.txt");
	...
	public void save(String filename) throws Exception{
		...
		writer.flush(); 
		for(int i=0;i<size;++i){
			line = model.getValueAt(i,0)+"_"+model.getValueAt(i,1);
			writer.write(line);
			writer.newLine();
			writer.flush(); 
		}
