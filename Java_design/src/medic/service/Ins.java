...
public class Ins extends JFrame{
	 ...
	 * @throws Exception 
	 */
	public Ins(int i) throws Exception {
	...
	public Ins() {
        ...
        try {
			readper("D:\\eclipse files\\java-neon\\Java_design\\files\\institution.txt");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\institution.txt");
