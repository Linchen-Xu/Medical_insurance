...
public class Med extends JFrame{
	...
	String[] column = {"id","name","chargelevel","limit","approval","hoslevel"};
	 ...
	 * @throws Exception 
	 */
	public Med(int i) throws Exception {
	...
	public Med() {
        ...
        try {
			readper("D:\\eclipse files\\java-neon\\Java_design\\files\\medicine.txt");
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\medicine.txt");
        		} catch (Exception e1) {
        			e1.printStackTrace();
        		}
        	}  
	...
	public void save(String filename) throws Exception{
		...
		for(int i=0;i<size;++i){
			line = model.getValueAt(i,0)+"_"+model.getValueAt(i,1)+"_"+model.getValueAt(i,2)+"_"+model.getValueAt(i,3)+
					"_"+model.getValueAt(i,4)+"_"+model.getValueAt(i,5);
			writer.write(line);
			writer.newLine();
			writer.flush(); 
		}
