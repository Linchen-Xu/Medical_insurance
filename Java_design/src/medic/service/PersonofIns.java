...
public class PersonofIns extends JFrame{
	...
	String[] column = {"code","id","category","permitted"};
	String[] data = {"","","",""};
	Integer size;
	/**
	 ...
	 * @throws Exception 
	 */
	public PersonofIns(int i) throws Exception {
		
		//System.out.println(1111);
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonofIns data1 = new PersonofIns();
					data1.setTitle("人员就诊机构审批");
	...
	public PersonofIns() {
        ...
        try {
			readPersonofIns("D:\\eclipse files\\java-neon\\Java_design\\files\\personofinsti.txt");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\personofinsti.txt");
	...
	public void readPersonofIns(String filename) throws Exception{
