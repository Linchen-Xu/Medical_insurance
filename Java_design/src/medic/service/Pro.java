...
public class Pro extends JFrame{
	...
	String[] column = {"id","name","kind","level","approval"};
	 ...
	 * @throws Exception 
	 */
	public Pro(int i) throws Exception {
	...
	public Pro() {
        ...
        try {
			readper("D:\\eclipse files\\java-neon\\Java_design\\files\\projects.txt");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\projects.txt");
