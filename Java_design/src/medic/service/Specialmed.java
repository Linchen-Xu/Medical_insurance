...
public class Specialmed extends JFrame{
	 ...
	 * @throws Exception 
	 */
	public Specialmed(int i) throws Exception {
		
		//System.out.println(1111);
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Specialmed data1 = new Specialmed();
					data1.setTitle("特检特治审批");
	...
	public Specialmed() {
        ...
        try {
			readSpecialmed("D:\\eclipse files\\java-neon\\Java_design\\files\\specialmed.txt");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        ...
        saveButton.addActionListener(new ActionListener(){//添加事件  
        	public void actionPerformed(ActionEvent e){  
        		try {
        			save("D:\\eclipse files\\java-neon\\Java_design\\files\\specialmed.txt");
	...
	public void readSpecialmed(String filename) throws Exception{
